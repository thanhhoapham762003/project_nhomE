                        ...
                        @foreach ($data_latestproduct as $data)
                            <div class="thubmnail-recent">
                                <a href="{{ route('latest.product', $data->id) }}"><img
                                        src="{{ asset('img/' . $data->latestproduct_image) }}" alt=""
                                        class="recent-thumb"></a>
                                <h2><a href="{{ route('latest.product', $data->id) }}">{{ $data->latestproduct_name }}</a>
                                </h2>
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-remove">
                                                        <a title="Remove this item" class="remove"
                                                            href="{{ route('cart.remove', $value['productId']) }}">×</a>
                                                    </td>

                                                    <td class="product-thumbnail">
                                                        <a href="{{ route('single.product', $value['productId']) }}"><img
                                                                width="145" height="145" alt="poster_1_up"
                                                                class="shop_thumbnail"
                                                                src="{{ asset('img') }}/{{ $value['product_image'] }}"></a>
                                                    </td>

                                                    <td class="product-name">
                                                        <a
                                                            href="{{ route('single.product', $value['productId']) }}">{{ $value['product_name'] }}</a>
                                                    </td>

                                                    <td class="product-price">
                                                        <span
                                                            class="amount">{{ number_format($value['product_price'], 0, ',', '.') }}
                                                            vnđ</span>
                                                    </td>

                                                    <td class="product-quantity">
                                                        <div class="quantity buttons_added">
                                                            <input name="quantities[{{ $value['productId'] }}]"
                                                                style="text-align: center;" type="number" size="4"
                                                    ...
                                                    <td class="product-subtotal">
                                                        <span
                                                            class="amount">{{ number_format($value['product_price'] * $value['quantity'], 0, ',', '.') }}
                                                            vnđ</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                                <td class="actions" colspan="6">
                                                    <input style="border-radius: 10px;margin-right: 30px;" type="submit"
                                                    ...
                                                    <a href="{{ route('checkout', []) }}" style="border-radius: 10px;"
