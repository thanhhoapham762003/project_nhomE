...
// Route::post('/cart_add/{add}', [CartController::class, 'add'])->name('cart.add');
// Route::get('/cart_add/{addJustOne}', [CartController::class, 'addJustOne'])->name('cart.addJustOne');
// Route::get('/cart_remove/{remove}', [CartController::class, 'remove'])->name('cart.remove');
// Route::post('/cart_update', [CartController::class, 'update'])->name('cart.update');
Route::prefix('/')->group(function () {
    Route::get('/', [HomeController::class, 'index'])->name('index');
    Route::get('/index', [HomeController::class, 'index'])->name('index');
    Route::prefix('/cart')->group(function () {
        Route::get('/{listproduct}', [CartController::class, 'listproduct'])->name('cart.product');//done
        Route::post('/add/{id}', [CartController::class, 'add'])->name('cart.add');//done
        Route::get('/addJustOne/{id}', [CartController::class, 'addJustOne'])->name('cart.addJustOne');//done
        Route::get('/remove/{id}', [CartController::class, 'remove'])->name('cart.remove');//done
