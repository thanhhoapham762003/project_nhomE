                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="{{route('single.product','$product -> id')}}"><img width="145" 
                                                height="145" alt="poster_1_up" class="shop_thumbnail" src="{{asset('img')}}/{{$value['product_image']}}"></a>
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
                                                    ...
                                                    type="number" size="4" class="input-text qty text" title="Qty" value="{{$value['quantity']}}" min="0" step="1">
                                                </div>
                                            </td>
