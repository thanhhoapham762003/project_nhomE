@extends('app')
    ...
    <tr class="cart_item">
        ...
        <td class="product-thumbnail">
            <a href="{{ route('single.product', $value->product->id) }}">
                <img width="145" height="145" alt="product" class="shop_thumbnail" src="{{ asset('img/' . $value->product->product_image) }}">
            </a>
        </td>
        ...
        <td class="product-price">
            <span class="amount">{{ number_format($value->product->product_price, 0, ',', '.') }} vnđ</span> 
        </td>
        ...
        <td class="product-subtotal">
            <span class="amount">{{ number_format($value->product->product_price * $value->quantity, 0, ',', '.') }} vnđ</span> 
        </td>
    </tr>
    @endif
@endforeach
