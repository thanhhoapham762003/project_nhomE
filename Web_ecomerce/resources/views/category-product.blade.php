            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <form action="{{route('cart.add','add')}}" class="cart" method="post">
                        ...
                        <button style="margin-left: 65px;width: 130px;padding: 10px;margin-top:10px;"
                         class="add_to_cart_button" data-quantity="1" data-product_sku="" 
                         data-product_id="70" rel="nofollow">Add to cart</button>
                    </form>
                </div>
            </div>
            @endforeach
