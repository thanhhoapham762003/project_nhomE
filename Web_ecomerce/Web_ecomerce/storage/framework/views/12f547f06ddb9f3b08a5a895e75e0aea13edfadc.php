...
<body>
            ...
            <?php if(Route::has('login')): ?>
                <div class="login">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">
                            <div> xinh chào :<?php echo e(Auth::user()->name); ?></div>
                        </a>
                    <?php else: ?>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <?php $__currentLoopData = $data_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('category', $data->id)); ?>"
                                            class="menu_categories"><?php echo e($data->name); ?></a>
                        ...
                        <li>
                            <a href="<?php echo e(route('cart.product', 'listproduct')); ?>"><i class="fa fa-shopping-cart"></i>
                                <span class="product-count"></span></a>
                        </li>
                        <li>
                            <form action="<?php echo e(route('timkiem.product', 'searchproduct')); ?>" method="get">
    ...
    <?php echo $__env->yieldContent('content-index'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <!-- <?php $__currentLoopData = $data_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a style="margin-left: 40px;" href="<?php echo e(route('category',$data->id)); ?>" class="menu_categories"><?php echo e($data->name); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> -->
                        </ul>
                    </div>
                </div>
...
<?php /**PATH D:\Back End 2\projectNhomC-camnhi_cuoiky_20240517_09h00\Web_ecomerce\resources\views/home.blade.php ENDPATH**/ ?>