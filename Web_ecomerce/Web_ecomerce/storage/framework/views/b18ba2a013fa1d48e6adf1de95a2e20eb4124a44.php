            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <!--Thêm Nav -->
                        <li>
                            <form role="timkiem" action="<?php echo e(route('timkiem.product', 'searchproduct')); ?>"
                                method="get">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <?php $__currentLoopData = $data_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a style="margin-left: 40px;" href="<?php echo e(route('category', $data->id)); ?>"
                                    class="menu_categories"><?php echo e($data->name); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
...
<?php /**PATH D:\Thuong_mai_dien_tu\Web_ecomerce\Web_ecomerce\resources\views/category-timkiem.blade.php ENDPATH**/ ?>