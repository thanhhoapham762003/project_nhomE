            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <?php $__currentLoopData = $data_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(route('category',$data->id)); ?>" class="menu_categories"><?php echo e($data->name); ?></a>
                        ...
                        <a href="<?php echo e(route('cart.product','listproduct')); ?>"><i class="fa fa-shopping-cart"></i> <span class="product-count"></span></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php /**PATH D:\Back End 2\projectNhomC-camnhi_cuoiky_20240517_09h00\Web_ecomerce\resources\views/app.blade.php ENDPATH**/ ?>