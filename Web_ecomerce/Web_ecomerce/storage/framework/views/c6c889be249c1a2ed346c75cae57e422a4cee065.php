...
<div class="card" style="margin:20px;">
  ...
  <div class="card-body">
      ...
      <form action="<?php echo e(route('admin_product.AddProduct')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin_product.layout_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Back End 2\projectNhomC-camnhi_cuoiky_20240517_09h00\Web_ecomerce\resources\views/admin_product/createProduct.blade.php ENDPATH**/ ?>